...
vim.opt.linebreak = true -- wrap on word, not on letter
vim.opt.showbreak = "↪"  -- Display character on wrapped lines

---------- ROLL IN EXTERNAL CONFIG FILES ----------
-- LUA CONFIGS --
dofile(vim.fn.expand('~/.config/nvim/keybinds.lua'))

-- VIMSCRIPT CONFIGS --
vim.cmd("source ~/.config/nvim/vimwiki_config.vim")
